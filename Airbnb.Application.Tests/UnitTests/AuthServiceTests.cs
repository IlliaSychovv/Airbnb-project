...
//         // kafkaOptionsMock
//         //     .Setup(m => m.Value).Returns(new KafkaOptions{ Topic = "test" });
//         
//
//         var authService = new AuthService(userManagerMock.Object, jwtTokenServiceMock.Object, kafkaProducerMock.Object, kafkaOptionsMock.Object);
//         
//         var result = await authService.RegisterUserAsync(dto);
//         
//         result.Succeeded.ShouldBeTrue();
//         kafkaProducerMock.Verify(m => m.ProduceAsync("test", It.IsAny<string>()), Times.Once); 
//     }
//
//     [Fact]
...
//         kafkaOptionsMock
//             .Setup(m => m.Value)
//             .Returns(new KafkaOptions{ Topic = "test" });
//         
//         var authService = new AuthService(userManagerMock.Object, jwtTokenServiceMock.Object, kafkaProducerMock.Object, kafkaOptionsMock.Object);
//         
//         var result = await authService.RegisterUserAsync(dto);
